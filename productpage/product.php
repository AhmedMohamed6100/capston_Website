        ...
        <div class="imag-container d-flex">
            <div class="imgs">
                <div class="image-container">
                    <img src="../image/pro1.webp" alt="One Life Graphic T-shirt">
                    <img src="../image/pro2.webp" alt="One Life Graphic T-shirt">
                    <img src="../image/pro3.webp" alt="One Life Graphic T-shirt">
                    <img src="../image/pro4.webp" alt="One Life Graphic T-shirt">
                </div>
            </div>
            <div class="imginfo">
                ...
                <div class="pdp-product__buttons modified-flex">
                    <div>
                        <form>
                            <input type="hidden" name="product_name" value="Relaxed Fit Hoodie">
                            <input type="hidden" name="product_price" value="212">
                            <input type="hidden" name="product_image" value="../image/pro1.webp">
